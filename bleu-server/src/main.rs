        ...
        App::new()
            ...
            .service(
                web::scope("/api/v1")
                    ...
                    .service(web::resource("/optimism/batch/tx").route(web::get().to(optimism::get_paginated_tx_batch)))
                    ...
                    .service(web::resource("/optimism/tx/batch/index/{index}").route(web::get().to(optimism::get_paginated_tx_by_tx_batch_index)))
                    .service(web::resource("/optimism/tx/stateroot/index/{index}").route(web::get().to(optimism::get_paginated_tx_by_state_batch_index)))
                    .service(web::resource("/optimism/tx/address/{address}").route(web::get().to(optimism::get_paginated_tx_by_address)))
                    .service(web::resource("/optimism/batch/stateroot").route(web::get().to(optimism::get_paginated_state_batch)))
